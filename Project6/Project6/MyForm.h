...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Text = L"Расход топлива (на 100км)";
			// 
			// label3
			// 
			...
			this->label3->Text = L"Цена еденицы топлива";
			// 
			// label4
			// 
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(163, 45);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(163, 79);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(163, 118);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(97, 164);
			...
			this->label5->Location = System::Drawing::Point(13, 214);
